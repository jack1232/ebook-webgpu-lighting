import frag_shader from './soft-spot-frag.wgsl';
...
export const run = async () => {
    ...
    const p = await cci.createPipeline(init, data, frag_shader, numObjects, 64, 36);
    ...
    let lightPosition = new Float32Array([-4, -4, -8]);
    ...
    const frame = () => {     
        ...
        init.device.queue.writeBuffer(p.uniformBuffers[5], 0, Float32Array.of(
            ...
            params.quadratic, params.cutoff, params.outerCutoff
        ));
